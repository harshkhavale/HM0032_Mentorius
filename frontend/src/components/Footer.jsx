...
import { footer, logo, man } from "../assets";

const Footer = () => {
  return (
    <div>
      <footer className="z-[1000] text-black bg-white lg:grid lg:grid-cols-5 dark:bg-dark w-[98.9vw] relative bottom-0 ">
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <img src={logo} alt="" className="md:w-[20vw] pb-20" />
              <p>
